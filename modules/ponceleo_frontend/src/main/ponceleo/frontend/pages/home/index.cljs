(ns ponceleo.frontend.pages.home.index
  "This namespace defines the home page of the SPA.
  See the `home_page` component to understand the page's structure "
  (:require
    [ponceleo.frontend.pages.home.component.contact-form :refer [contact-form]]
    [ponceleo.frontend.pages.home.component.feature-card :refer [feature-card]]
    [ponceleo.frontend.pages.home.component.motto :refer [motto-section]]
    [ponceleo.frontend.pages.home.component.stat-card :refer [stat-card]]
    [ponceleo.frontend.pages.home.component.subscribe-form :refer
     [subscribe-section]]
...
(defn stats
  ...
  []
  [:div#stats {:class ["relative" "bg-stats-image" "bg-cover"
...
(defn contact
  ...
  (fn []
    [:div#contact
     {:class ["mx-8" "md:mx-auto" "md:w-1/2" "py-4" "text-center" "h-3/4"]}
